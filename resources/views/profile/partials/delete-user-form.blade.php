<section class="space-y-6">
  <header>
    ...
    <p class="mt-1 text-sm text-gray-600">
      Una vez que elimine su cuenta, todos sus recursos y datos se eliminarán
      permanentemente. Antes de eliminar su cuenta, descargue cualquier dato o
  ...
  <x-modal name="confirm-user-deletion"
    ...
    <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
      ...
      <p class="mt-1 text-sm text-gray-600">
        ...
        eliminarán permanentemente. Por favor, ingrese su contraseña para
