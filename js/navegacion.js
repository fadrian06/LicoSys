...
var moduloNuevaCompra = function moduloNuevaCompra(contenedor) {
  ...
  $('[proveedor-id]').on('click', function (e) {
    ...
    $.get("backend/nuevaCompra.php?proveedorID=".concat(id), function (res) {
      ...
      datosProveedor.innerHTML = "\n\t\t\t\t<div class=\"w3-bottombar\">\n\t\t\t\t\t<p><b>Persona de contacto</b></p>\n\t\t\t\t\t<li>\n\t\t\t\t\t\t<span class=\"w3-tag w3-blue w3-left\">C\xE9dula:</span>\n\t\t\t\t\t\t<b class=\"w3-right\">".concat(respuesta.datos.cedula, "</b>\n\t\t\t\t\t\t<div class=\"w3-clear\"></div>\n\t\t\t\t\t</li>\n\t\t\t\t\t<li>\n\t\t\t\t\t\t<span class=\"w3-tag w3-blue w3-left\">Nombre:</span>\n\t\t\t\t\t\t<b class=\"w3-right\">").concat(respuesta.datos.nombre, "</b>\n\t\t\t\t\t\t<div class=\"w3-clear\"></div>\n\t\t\t\t\t</li>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"w3-bottombar\">\n\t\t\t\t\t<p><b>Datos del proveedor</b></p>\n\t\t\t\t\t<li>\n\t\t\t\t\t\t<span class=\"w3-tag w3-blue w3-left\">RIF:</span>\n\t\t\t\t\t\t<b class=\"w3-right\">").concat(respuesta.datos.rif, "</b>\n\t\t\t\t\t\t<div class=\"w3-clear\"></div>\n\t\t\t\t\t</li>\n\t\t\t\t\t<li>\n\t\t\t\t\t\t<span class=\"w3-tag w3-blue w3-left\">Nombre:</span>\n\t\t\t\t\t\t<b class=\"w3-right\">").concat(respuesta.datos.nombreEmpresa, "</b>\n\t\t\t\t\t\t<div class=\"w3-clear\"></div>\n\t\t\t\t\t</li>\n\t\t\t\t\t<li>\n\t\t\t\t\t\t<span class=\"w3-tag w3-blue w3-left\">Tel\xE9fono:</span>\n\t\t\t\t\t\t<b class=\"w3-right\">").concat(respuesta.datos.telefono, "</b>\n\t\t\t\t\t\t<div class=\"w3-clear\"></div>\n\t\t\t\t\t</li>\n\t\t\t\t\t<li>\n\t\t\t\t\t\t<span class=\"w3-tag w3-blue w3-left\">Direcci\xF3n:</span>\n\t\t\t\t\t\t<b class=\"w3-right\">").concat(respuesta.datos.direccion, "</b>\n\t\t\t\t\t\t<div class=\"w3-clear\"></div>\n\t\t\t\t\t</li>\n\t\t\t\t</div>\n\t\t\t");
    });
  });
    ...
    enlace.addEventListener('click', function (e) {
      ...
      if (enlace.href.includes('dashboard.php'))
        ...
        return setTimeout(function () {
          ...
          if (document.querySelector('#productosMasVendidos')) new Chart('productosMasVendidos', {
            type: 'bar',
            data: {
              labels: xValues,
              datasets: [{
