...
<main class="w3-main w3-container">
	...
	<button id="agregarCliente" class="w3-button w3-green w3-circle"><span class="icon-plus"></span></button>
		...
		<table class="w3-table w3-centered">
			...
			<tr>
				...
				<form>
					...
					<td><input class="w3-input" type="number" name="cantidad" id="cantidad" max="<?=isset($_GET['stock']) ? $_GET['stock'] : ''?>" onkeyup="precioTotal()" onchange="precioTotal()" min="0" max="20"></td>
