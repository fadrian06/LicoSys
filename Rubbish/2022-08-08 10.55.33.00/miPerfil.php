	...
	if(isset($_POST["actualizarFoto"])):
		...
		if($tipo == "image/jpeg" || $tipo == "image/jpg" || $tipo == "image/png"):
			if($peso < 1*1000*2048 /*2MB*/):
				if(ACTUALIZAR("UPDATE usuario SET foto='$foto' WHERE usuario='$usuario'")):
					$_SESSION["foto"] = $foto;
					move_uploaded_file($dirTemporal, "../imagenes/perfil/$foto");
					$notificacion = "
						<script>
							Swal.fire({
							...
							document.querySelector('#fotoPerfil').src = '../imagenes/perfil/$foto';
							document.querySelector('#img-result').src = '../imagenes/perfil/$foto';
						</script>
					";
				endif;
			else:
...
<main class="w3-container w3-main w3-row" id="miPerfil">
	...
	<div class="w3-rest">
		...
		<div class="w3-threequarter w3-margin-top w3-container w3-card w3-white w3-hide" id="panelSeguridad">
			...
			<form action="" method="POST" class="w3-center w3-hide w3-small w3-padding-16" id="formulario-actualizar-preguntas">
				...
				<div class="w3-row w3-section">
					...
					<input type="text" minlength="4" maxlength="20" name="respuesta1" class="w3-twothird w3-input" id="respuesta1">
				</div>
				<div class="w3-row w3-section">
				...
				<div class="w3-row w3-section">
					...
					<input type="text" minlength="4" maxlength="20" name="respuesta2" class="w3-twothird w3-input" id="respuesta2">
				</div>
				<div class="w3-row w3-section">
				...
				<div class="w3-row w3-section">
					...
					<input type="text" minlength="4" maxlength="20" name="respuesta3" class="w3-twothird w3-input" id="respuesta3">
				</div>
		...
		=============================================-->
		<form class="formulario-foto w3-quarter w3-center w3-white w3-leftbar" enctype="multipart/form-data" action="" method="POST">
			<label for="foto" class="w3-display-container w3-hover-opacity" style="background:url() top/contain no-repeat">
				<i class="icon-camera w3-xxxlarge w3-display-middle"></i>
				<input type="file" name="foto" id="foto" class="w3-hide">
				<img class="image-result" src="<?=!empty($_SESSION["foto"]) ? "../imagenes/perfil/{$_SESSION["foto"]}" : "../imagenes/avatar2.png"?>" id="img-result">
			</label>
