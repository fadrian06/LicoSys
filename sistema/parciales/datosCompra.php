				...
				<form method="POST">
					...
					<td>
						<div class="tooltip-container">
							<input style="width: max-content" class="w3-input w3-center" type="text" name="precioB" value="$ " required pattern="^\$ [\d.]+$" title="Sólo números, un punto y 2 decimales">
							<span class="tooltip">
					...
					<td>
						<input style="width: max-content" class="w3-input" type="number" name="cantidad" min="1">
					</td>
					<td>
						<input style="width: max-content" class="w3-input w3-center w3-disabled" readonly type="text" name="precioT" id="precioT">
					</td>
					<td>
