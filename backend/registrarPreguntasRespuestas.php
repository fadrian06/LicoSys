<?php
	...
	if (!empty($_POST)):
		...
		$pre1 = escapar($_POST['pre1']);
		$pre2 = escapar($_POST['pre2']);
		$pre3 = escapar($_POST['pre3']);
		...
		$sql = "UPDATE usuarios SET 
			pre1='$pre1', pre2='$pre2', pre3='$pre3', 
			res1='$res1', res2='$res2', res3='$res3' WHERE id='{$_SESSION['userID']}'
		";
