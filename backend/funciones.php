 ...
 * @param array{escritorio: string[], movil: string[]} $encabezados
 * @param array{camposEscritorio: string[], camposMovil: string[], filas: array<string, mixed>[]} $datos
 * @param string $sinRegistros Texto a mostrar cuando no existan filas.
 * @param array{tabla: string, campo: string, enlace: string, filas: array<string, mixed>[]}|false $desactivar
 * @param array{tabla: string, campo: string, enlace: string, IDform: string}|false $actualizar
 */
function tabla(
  string $titulo,
  array $encabezados,
  array $datos,
  string $sinRegistros = '',
  array|false $desactivar = false,
  array|false $actualizar = false,
  bool $factura = false,
): void {
  $filasEscritorio = '';
  $filasMovil = '';
