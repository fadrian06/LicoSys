<?php
  ...
  if (!empty($negocios) and !empty($admin)):
    $titulo = "Acerca de <small>{$getenv('APP_NAME')}</small>";
    $contenido = <<<HTML
      <div class="w3-row">
        <div class="w3-third w3-padding-large w3-center">
          <img src="resources/images/logo.png" class="w3-image">
        </div>
        <p class="w3-padding-large w3-rest w3-xlarge w3-justify">
          &nbsp;&nbsp;&nbsp;{$getenv('APP_NAME')} es un sistema administrativo que
      ...
      <p class="w3-container w3-large w3-justify">
        Todo desde la comodidad de tu equipo preferido, {$getenv('APP_NAME')} funciona tanto
      ...
      <img src="resources/images/devices.jpg" class="w3-image">
      <p class="w3-container w3-large w3-justify">
        &nbsp;&nbsp;&nbsp;{$getenv('APP_NAME')} está fuertemente centrado en la
