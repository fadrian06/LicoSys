			...
			<div class="input-radio">
				<?php foreach($negocios as $negocio): ?>
					<div class="radio-group tooltip-container">
						...
						<label for="negocio#<?=$negocio["id_n"]?>" style="background:url(<?=!empty($negocio["foto"]) ? "images/negocios/{$negocio["foto"]}" : "images/logoNegocio.jpg"?>) center/contain no-repeat"></label>
