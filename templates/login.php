...
if (isset($mostrarLogin)) : ?>
  <main class="w3-row w3-animate-zoom" id="mainLogin">
    ...
    <aside
      class="
        w3-padding-large w3-hide-small w3-col l6 m5 w3-display-container
        w3-topbar w3-bottombar w3-leftbar w3-rightbar w3-border-black
        w3-round-xlarge
      ">
      <div
        id="typed-container"
        ...
        class="w3-padding-large w3-xlarge w3-right w3-hover-black">
            ...
            echo <<<HTML
                <div class="w3-col s4 w3-dropdown-hover w3-white">
                  <input
                    ...
                    class="w3-hide" />
                  <label
                    for="negocio#{$negocio['id']}"
                    class="
                      w3-block w3-topbar w3-bottombar w3-leftbar w3-rightbar
                      w3-border-black w3-round-xlarge w3-center
                    ">
