...
/**
 * @var int $salesCartProductsAmount
 * @var int $shoppingCartProductsAmount
 */

assert(is_int($salesCartProductsAmount));
assert(is_int($shoppingCartProductsAmount));
  ...
  <div class="w3-row">
    <div class="w3-half w3-medium w3-dropdown-hover w3-black">
      <a href="views/nuevaVenta.php" role="navegacion" title="Nueva Venta" class="w3-large w3-button">
        ...
        <b id="productosEnCarrito"><?= $salesCartProductsAmount ?></b>
      </a>
      ...
      echo <<<HTML
            <div class="w3-half w3-medium w3-dropdown-hover w3-black">
              <a
                ...
                <b id="productosEnCarritoCompra">{$shoppingCartProductsAmount}</b>
              </a>
