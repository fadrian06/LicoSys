...
w3.dataObject = {}, w3.displayObject = function (id, data) {
  ...
  for (j = l - 1; j >= 0; j -= 1) {
    ...
    if (repeatObj && _typeof(repeatObj) == "object" && repeatObj.length != "undefined") {
      i = 0;
      for (x in repeatObj) {
        i += 1;
        rowClone = arr[j];
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (w3);
...
/* harmony import */ var _librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../librerias/w3/w3.js */ "./librerias/w3/w3.js");
...
var ojos = _librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElements('.icon-eye');
...
function actualizarFoto() {
  var inputsFile = _librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElements("input[type='file']");
  var images = _librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElements("img.image-result");
  var submits = false;
  var spans = false;
  if (_librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElements("input[name='actualizarFoto']")) {
    submits = _librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElements("input[name='actualizarFoto']");
    spans = _librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElements(".formFoto span");
  }
...
function validar(form) {
  var inputs = _librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElements("#".concat(form.id, " input"));
  var radios = false;
  var idForm = form.id;
  if (_librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElements("#".concat(form.id, " input[type=\"radio\"]"))) {
    radios = _librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElements("#".concat(form.id, " input[type=\"radio\"]"));
  }
  var expresiones = {
  ...
  function verificar(e) {
    ...
    if (idForm == "formNegocio") {
      if (!campos.nombreNegocio) {
        e.preventDefault();
        error(_librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElement("input[name='nombreNegocio']"));
        alerta("Verifique el nombre del negocio");
      } else if (!campos.rif) {
        e.preventDefault();
        error(_librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElement("input[name='rif']"));
    ...
    if (idForm == "formMonedas") {
      if (!campos.iva) {
        e.preventDefault();
        error(_librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElement("input[name='iva']"));
        alerta("Verifique el IVA");
      }
      if (!campos.dolar) {
        e.preventDefault();
        error(_librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElement("input[name='dolar']"));
        alerta("Verifique el monto en Bs.");
      }
      if (!campos.peso) {
        e.preventDefault();
        error(_librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElement("input[name='peso']"));
    ...
    if (idForm == "formAdmin" || idForm == "formLogin" || idForm == "formularioRegistrarUsuario" || idForm == "formPerfil") {
      if (!campos.usuario) {
        e.preventDefault();
        error(_librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElement("input[name='usuario']"));
    ...
    if (idForm == "formAdmin" || idForm == "formularioRegistrarUsuario" || idForm == "formClave" || idForm == "formActualizarClave") {
      if (!campos.clave) {
        e.preventDefault();
        error(_librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElement("input[name='nuevaClave']"));
        alerta("Verifique la contraseña");
      } else if (!campos.confirmar) {
        e.preventDefault();
        error(_librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElement("input[name='confirmar']"));
    ...
    if (idForm == "formAdmin" || idForm == "formularioRegistrarCliente" || idForm == "formularioRegistrarUsuario" || idForm == "formPerfil") {
      if (!campos.cedula) {
        e.preventDefault();
        error(_librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElement("input[name='cedula']"));
        alerta("Verifique la cédula");
      } else if (!campos.nombre) {
        e.preventDefault();
        error(_librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElement("input[name='nombre']"));
    ...
    if (idForm == "formLogin") {
      if (!campos.clave) {
        e.preventDefault();
        error(_librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElement("input[name='clave']"));
        alerta("Verifique la contraseña");
      }
      if (!campos.negocio) {
        e.preventDefault();
    ...
    if (idForm == "formularioRegistrarProducto" || idForm == "formEditProducto") {
      if (!campos.codigo) {
        e.preventDefault();
        error(_librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElement("input[name='codigo']"));
        alerta("Verifique el código");
      }
      if (!campos.nombreProducto) {
        e.preventDefault();
        error(_librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElement("input[name='nombreProducto'"));
        alerta("Verifique el nombre");
      }
      if (!campos.stock) {
        e.preventDefault();
        error(_librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElement("input[name='stock']"));
        alerta("Verifique el campo 'Existencia'");
      }
      if (!campos.precio) {
        e.preventDefault();
        error(_librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElement("input[name='precio']"));
        alerta("Verifique el campo 'Precio'");
      }
      if (idForm == "formularioRegistrarProveedor") {
        if (!campos.nombreProveedor) {
          e.preventDefault();
          error(_librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElement("input[name='nombreProveedor']"));
          alerta("Verifique el nombre");
        }
      }
  ...
  function compararClaves() {
    var clave1 = _librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElement("input[name='nuevaClave']");
    var clave2 = _librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_1__["default"].getElement("input[name='confirmar']");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../librerias/w3/w3.js */ "./librerias/w3/w3.js");
/* harmony import */ var _funciones_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./funciones.js */ "./src/modules/funciones.js");


var overlay = _librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_0__["default"].getElement(".w3-overlay");
var formNegocio = _librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_0__["default"].getElement("#formNegocio");
var formAdmin = _librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_0__["default"].getElement("#formAdmin");
var formLogin = _librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_0__["default"].getElement("#formLogin");
var formRecuperar = _librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_0__["default"].getElement("#formConsulta");
var formPreguntas = _librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_0__["default"].getElement("#formPreguntas");
var formClave = _librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_0__["default"].getElement("#formClave");
...
if (formLogin) {
  ...
  (0,_funciones_js__WEBPACK_IMPORTED_MODULE_1__.validar)(formRecuperar);
  (0,_funciones_js__WEBPACK_IMPORTED_MODULE_1__.modal)(enlace, formRecuperar, overlay);
  var contenedorReloj = _librerias_w3_w3_js__WEBPACK_IMPORTED_MODULE_0__["default"].getElement(".widget");
  (0,_funciones_js__WEBPACK_IMPORTED_MODULE_1__.reloj)(contenedorReloj);
  setInterval(function () {
    return (0,_funciones_js__WEBPACK_IMPORTED_MODULE_1__.reloj)(contenedorReloj);
  }, 1000 * 60);
  if (formPreguntas) {
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_funciones_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/funciones.js */ "./src/modules/funciones.js");
/* harmony import */ var _modules_login_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/login.js */ "./src/modules/login.js");
