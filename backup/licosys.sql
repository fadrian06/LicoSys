...
INSERT INTO negocios VALUES(1, 'Licorería Don Ramón', 'V12345678901', '04165335826', 'El Pinar, Carretera Panamericana', '1.jpeg', 1);

INSERT INTO negocios VALUES(2, 'Taberna Los 7 Hermanos', 'V9239239279', '', 'El Pinar, Carretera Panamericana', '2.jpeg', 1);

INSERT INTO negocios VALUES(3, 'Distribuidora La Gigante', 'E232323232', '', '', '3.jpeg', 1);

INSERT INTO negocios VALUES(4, 'Negocio De Prueba', 'V29429329392', '', '', '', 0);
...
INSERT INTO usuarios VALUES(NULL, 23892005, 'emerson', 'Emerson', '$2y$10$0fV9z2EXRghQqd9ECyixSO/VLoRFp1jfwKXznlVfPL9h.rA26/eJ2', 'v', '', '', '', '', '', '', '', '', 1);

INSERT INTO usuarios VALUES(NULL, 28072391, 'franyer', 'Franyer', '$2y$10$bQvLHZqhTWvyJkMcEw0KWubxzgmiW8WdOdJ/qOfjUEVZQv9dCgVDe', 'v', '04165335826', 'Color', '$2y$10$FTa5TgTukhlWbYOlyyg3/uRv0ApcrJ7WGAkMh95s0jNoTbmTELs26', 'Carrera universitaria', '$2y$10$D1/O1I7Lxjb1w.Jtt7X74e7JXavj3zZqBtgzH8Zb3X38eVPdSjjx6', 'Mejor amiga', '$2y$10$9UbaOfKuGaVP5GIKm2rLqugX8kCuhH6nr.5HRMYe4.vO6XlkkNYD2', '28072391.jpeg', 0);

INSERT INTO usuarios VALUES(NULL, 28888888, 'admin', 'Administrador', '$2y$10$nVlRKjkv5BcPPo4lF.XXcefa.QLVVb1UjhXczIpSBiM.Mz8Rkr6VO', 'a', '04165335826', 'pregunta', '$2y$10$3Ii/4o1EkNRikHDKE98z5uFC7dUYi..CG3zpk9MIlpfmtgRLtTPRK', 'pregunta', '$2y$10$ud0H4d2leN7IMfZSfiIbluRkaKFJvPT47g5hHJJlzALxntzWw8O1O', 'pregunta', '$2y$10$jcnCVu2WYGDf2mYE26cUm.DOPAndwR3C4JRz/bzmRDGoIcE4OitJ.', '28888888.jpeg', 1);
